...
Model `deepseek/deepseek-v4-flash` · 16 cases · live run
...
|---|---|---|---|---|---|---|
| `v0_baseline` | single prompt (baseline) | **8/14** (57%) | 87.1% | 14 | 0.2702 | 31 min |
...
| Case | `v0_baseline` |
|---|---|
| case_01_inventory | 93% |
| case_02_blueprint_auth | 86% |
| case_03_app_config | — |
| case_04_error_handlers | — |
| case_05_response_shapes | 85% |
| case_06_query_params | **100%** |
| case_07_path_converters | **100%** |
| case_08_method_view | **100%** |
| case_09_bulk_status | **100%** |
| case_10_conditional_update | **100%** |
